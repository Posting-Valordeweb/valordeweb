...
$cron_jobs = array(
    array (
        "period"=>"0 0 * * *",
        "script"=>"cron_sitemap.php",
    ),
    array(
        "period"=>"0 0 * * *",
        "script"=>"cron_onsalechecker.php",
    ),
    array(
        "period"=>"0 0 * * 0",
        "script"=>"cron_garbagecollector.php",
    ),
);
...
<html lang="en">
<head>
<title>Website Worth Calculator | Command Builder</title>
</head>
<body>
<p>
    Below you can find a list of cron jobs you need to setup.
    <a href="https://docs.php8developer.com/website-worth-calculator/#/installation?id=cron-jobs" target="_blank">Read here</a> how you can do it.
</p>
<ul>
