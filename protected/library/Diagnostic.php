...
class Diagnostic
{
    ...
    private static $norUrl = 'https://safeweb.norton.com/safeweb/sites/v1/details?url=%s&insert=0';
    ...
    public static function mcafee($domain)
    {
        ...
        if(!$response = Helper::curl($url, $headers)) {
            return 'untested';
        }
        /*
...
//            'icoUntested-report' => 'untested',
//            'icoWarning' => 'caution',
//            'icoWarning-report' => 'caution',
//            'icoCaution' => 'warning',
//            'icoCaution-report' => 'warning',
//            'icoNSecured' => 'safe',
//        );
...
//        return isset($diagnose[$d]) ? $diagnose[$d] : 'untested';
        ...
        if(!$response = json_decode(Helper::curl($api_url), true)) {
            return 'untested';
        }
        ...
        return isset($diagnose[$response['rating']]) ? $diagnose[$response['rating']] : 'untested';
    }
}
